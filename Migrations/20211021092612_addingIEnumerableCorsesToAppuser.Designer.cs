...
namespace coursesSystem.Migrations
{
    ...
    [Migration("20211021092612_addingIEnumerableCorsesToAppuser")]
    partial class addingIEnumerableCorsesToAppuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUserCourse", b =>
                {
                    b.Property<int>("coursesListcourseId")
                        .HasColumnType("int");

                    b.Property<string>("studentsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("coursesListcourseId", "studentsId");
            ...
            modelBuilder.Entity("AppUserCourse", b =>
                {
                    b.HasOne("coursesSystem.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("coursesListcourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("coursesSystem.Models.AppUser", null)
                        .WithMany()
